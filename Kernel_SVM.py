...
class SVM(object):
	...
	def fit(self,X,y):
		...
		#support vectors have non 0 lagrange multipliers
		sv = a > 1e-5
		ind = np.arange(len(a))[sv]
		self.a = a[sv]
		self.sv = X[sv]
		self.sv_y = y[sv]
		print("%d sv of %d pointd"%(len(self.a),n_samples))
		#intercept
		self.b = 0
...
if __name__ == "__main__":
	...
	def plot_contour(X1_train,X2_train,clf):
		...
		p1.contour(X1,X2,z,[0.0],colors='grey',linewidths = 1,origin = 'lower')
	...
	def test_linear():
		X1,y1,X2,y2 = gen_lin_seprable_data()
